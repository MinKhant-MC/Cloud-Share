(function () {
  ...
  var textTargets = [
    ...
    ['body[data-page="sales"] thead th:nth-child(1)', 'date'],
    ['body[data-page="sales"] thead th:nth-child(2)', 'customerName'],
    ['body[data-page="sales"] thead th:nth-child(3)', 'productId'],
    ['body[data-page="sales"] thead th:nth-child(4)', 'quantity'],
    ['body[data-page="sales"] thead th:nth-child(5)', 'selectedRangeIncome'],
    ['body[data-page="sales"] thead th:nth-child(6)', 'profit'],
    ['body[data-page="sales"] thead th:nth-child(7)', 'action'],
